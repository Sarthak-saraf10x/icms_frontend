        ...
        <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_-20px_rgba(85,98,77,0.12)] border border-[#ecefe8] p-8 md:p-12">
          ...
          {step === 3 && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <form onSubmit={handlePurchase} className="space-y-6" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
                <div>
                  <label className="block text-sm font-bold text-[#444841] mb-2">Card Number</label>
                  <input 
                    type="text" 
                    placeholder="0000 0000 0000 0000"
                    value={paymentDetails.cardNumber}
                    onChange={(e) => setPaymentDetails({...paymentDetails, cardNumber: e.target.value})}
                    className="w-full rounded-xl bg-[#f8faf3] border border-[#ecefe8] py-4 px-4 text-[#191c18] font-mono focus:outline-none focus:ring-2 focus:ring-[#55624d]"
                    required
                  />
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-[#444841] mb-2">Expiry Date</label>
                    <input 
                      type="text" 
                      placeholder="MM/YY"
                      value={paymentDetails.expiry}
                      onChange={(e) => setPaymentDetails({...paymentDetails, expiry: e.target.value})}
                      className="w-full rounded-xl bg-[#f8faf3] border border-[#ecefe8] py-4 px-4 text-[#191c18] focus:outline-none focus:ring-2 focus:ring-[#55624d]"
                      required
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-[#444841] mb-2">CVV</label>
                    <input 
                      type="password" 
                      placeholder="***"
                ...
                <div>
                  <label className="block text-sm font-bold text-[#444841] mb-2">Name on Card</label>
                  <input 
                    type="text" 
                ...
                <div className="mt-10 pt-6 border-t border-[#ecefe8] flex justify-between items-center">
                  ...
                  >
                    {isLoading ? 'Processing...' : `Pay $${selectedPolicy?.base_premium}`}
